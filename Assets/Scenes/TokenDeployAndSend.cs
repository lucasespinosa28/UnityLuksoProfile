...
public class TokenDeployAndSend : MonoBehaviour
{
    ...
    public IEnumerator DeployAndTransferToken()
    {
        ...
        var url = "https://rpc.l16.lukso.network";
        var privateKey = "6426c6196d7f509ab2547f8bfafe352bbb2daaefc0eb059b17056f802cc06f22";
        var account = new Account(privateKey).Address;
        //initialising the transaction request sender

        var transactionRequest = new TransactionSignedUnityRequest(url, privateKey, 2828);
        //transactionRequest.UseLegacyAsDefault = true;
        Debug.Log(transactionRequest.Result);
        ...
        var transactionTransferRequest = new TransactionSignedUnityRequest(url, privateKey, 2828);
